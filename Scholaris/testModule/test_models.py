...
class ForumTestClass(TestCase):
    ...
    def setUpTestData(cls):
        ...
        Post.objects.create(title='my post', slug='my-post', author=user1, body='for_testing', tag='ASE', status='Published')
